...
### Some paths
train_file = './data/my_data/train2017.txt'  # The path of the training txt file.
val_file = './data/my_data/val2017.txt'  # The path of the validation txt file.
...
restore_exclude = ['yolov3/yolov3_head/detection_1', 'yolov3/yolov3_head/detection_2', 'yolov3/yolov3_head/detection_3']
...
'''
no_anchor_branch = True
exec anchor free branch in three feature maps
for input size = [416, 416]
anchor free barnch is 
[13 ,13], [26, 26], [52, 52]
'''
no_anchor_branch = [False, True, False]
anchor_branch = False
### some constants in validation
# nms
nms_threshold = 0.3  # iou threshold in nms operation
