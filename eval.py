...
# some paths
parser.add_argument("--eval_file", type=str, default="./data/my_data/val2017.txt",
...
# Model definition
##################
yolo_model = yolov3(args.class_num, args.anchors, Args.no_anchor_branch, Args.anchor_branch)
